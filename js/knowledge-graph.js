...
(function () {
    ...
    var PRESETS = {
        // «каркас» — все 3 типа узлов + все КРОСС-связи между ними, БЕЗ "сам-на-себя"
        // (тег-тег/закон-закон/учёный-учёный). ФАКТИЧЕСКИЙ дефолт при загрузке страницы —
        // 'law-sci' (см. checked= в templates/graph-explorer.html) — теги захламляли вид
        // (юзер-фидбек 2026-07-17: "граф оказывается перегружен"), 'core' остался как пресет-кнопка.
        core: ['law-tag', 'sci-tag', 'law-sci', 'law-influence'],
