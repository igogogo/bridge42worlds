...
(function () {
    ...
    var PRESETS = {
        // «каркас» — дефолт: все 3 типа узлов + все КРОСС-связи между ними, БЕЗ "сам-на-себя"
        // (тег-тег/закон-закон/учёный-учёный) — та же логика, что у мини-графа на карточках
        // (юзер-фидбек 2026-07-15: "унифицируй по вкладкам... везде один подход").
