/* figures.js — схемы-пояснения к шагам вывода формул.
   Каждая функция возвращает готовую SVG-строку. Внутри схем только математические обозначения
   (m, v, A, Δt, P) — они одинаковы на всех языках, поэтому SVG не требует перевода; словесные
   подписи живут в JSON урока (figCaption) и переводятся вместе с текстом.
