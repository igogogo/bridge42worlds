...
(function (global) {
    ...
    function pageLang() {
        ...
        return (window.B42_LANGS || ['ru', 'en', 'es', 'ar', 'fr']).indexOf(l) >= 0 ? l : 'ru';
    }
    function label(s) {
        var lang = pageLang();
    ...
    F.phaseellipse = function () {
        var W = 440, H = 254, cx = 208, cy = 128, rx = 106, ry = 56;
        ...
        s += '<line x1="' + cx + '" y1="' + (cy - ry - 24) + '" x2="' + cx + '" y2="' + (cy + ry + 24) +
             '" stroke="' + SOFT + '" stroke-width="1"/>';
        s += txt(cx + rx + 34, cy - 8, 'q', SOFT, 12);   // подпись оси уходила под «энергия в пружине»
        ...
        s += txt(W / 2, cy + ry + 46, 'p&#178;/2m + k&#8201;q&#178;/2 = E', INK, 12.5);
    ...
    F.stayoncurve = function () {
        ...
        s += '<line x1="' + (mx + 7) + '" y1="' + (my - 7) + '" x2="' + (mx - 7) + '" y2="' + (my + 7) +
             '" stroke="' + WARN + '" stroke-width="2.4"/>';
        s += txt(cx - 96, cy + 86, 'меньше энергии', SOFT, 10.5);
        s += txt(cx + 96, cy + 86, 'больше энергии', SOFT, 10.5);
        s += txt(W / 2, 226, 'dH/dt = 0', INK, 13);
...
F.realladder = function () {
    ...
    // честная оговорка: настоящие 3390/300 на лист не влезают, рисунок сжат по вертикали
    s += txt(434, 214, 'масштаб сжат: на деле ступенька выше kT в 11 раз', SOFT, 9, 'end');
    return svg(W, H, s);
};
...
/* ──────────────────────────────────────────────────────────────────────────
   ...
   realladder:
     ...
     'недосягаема'
     'i = 3 + 2 + 0 = 5, а не 7'
     'масштаб сжат: на деле ступенька выше kT в 11 раз'
