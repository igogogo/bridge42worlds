...
function openFromUrl() {
    ...
    /* ?group=25 — кадр области целиком. Страница понятия называет области, в
       которых предмет живёт, и ведёт прямо в них: человек, нажавший
       «Гидродинамика и турбулентность», хочет увидеть эту область, а не обзор
       из пятидесяти кругов, где её ещё надо найти. */
    var g = q.get('group');
    if (g !== null && g !== '' && !isNaN(+g)) { showGroup(+g, false); return true; }
    return false;
}
