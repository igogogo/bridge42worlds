...
# ОТДЕЛЬНАЯ база, не b42-queue. 5 августа заливка тридцати тысяч карточек в общую базу
# положила её на несколько минут: живые ручки (совет, реакции) отвечали 500, пока шла
# запись. Данные уцелели, но пересобираемому и невосстановимому не место в одной базе.
DB_NAME = "b42-cards"
