...
# Пятое место, где терялся французский, и единственное, где дело не в коде, а в данных:
# ключей ctx:*:fr в хранилище не было вовсе — ноль против ~1960 на каждый другой язык.
# Промпт бота-исследователя языконезависим («отвечай на языке вопроса»), поэтому по коду
