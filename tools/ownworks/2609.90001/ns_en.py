...
ADVANCED = {
    ...
    "oneliner": "For every viscosity: a smooth compactly supported force and a finite-energy solution from rest whose speed becomes unbounded at t = 1, settling Fefferman's alternatives (C) and (D). Proof scheme, scalings, the role of the pulses and the limits of the result.",
