...
def plan(money):
    ...
    steps += [
        ...
        {"key": "concepts", "title": "цикл роста понятий", "n": 30, "cost": 0.05},
...
def do_step(s):
    ...
    if k == "concepts":
        return run([sys.executable, "tools/concept_cycle.py", "--budget", "30"], timeout=3600)
    if k == "silent":
