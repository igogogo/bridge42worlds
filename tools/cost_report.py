...
DEFAULT_PRICES = {
    ...
    # Реранкер отбора. Три размера у одного поставщика — держим все три, чтобы смена
    # модели во флаге не превращалась в молчаливую ошибку в деньгах.
    "qwen3-reranker-0.6b": {"cache_hit": 0.0, "cache_miss": 0.010, "output": 0.0},
    "qwen3-reranker-4b":   {"cache_hit": 0.0, "cache_miss": 0.025, "output": 0.0},
    "qwen3-reranker-8b":   {"cache_hit": 0.0, "cache_miss": 0.050, "output": 0.0},
}
...
KIND = {
    ...
    "embed": "вектор", "vector_select": "вектор", "rerank": "вектор",
}
